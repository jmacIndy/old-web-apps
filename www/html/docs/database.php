...
<p>
Database connectivity and use is simple in Seven Kevins. The initial database connection is singleton which allows you to connect simply by calling the getInstance() method
</p>
<?php
$code='
<?php
