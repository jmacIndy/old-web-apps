...
<p>
Setting language translations in Seven Kevins is quite simple. You merely set the lang config option in the application/config/config.ini.php file to your language of choice and the language class is loaded automatically for you. The defaule is "en" or english. A demonstration french translation class is also provided, but you can make up as many as you like.
</p>
