...
$con = mysql_connect("localhost", "root", "nascar02");
...
mysql_select_db("PEM_OWNER", $con);

$trend_query = <<<EOD
SELECT PEM_TREND_ID,
       TREND_RCRD_TYP_CD,
       TREND_GENERE_DESC,
       TREND_ACPTNC_CRITERIA_DESC,
       TREND_SITE_DESC,
       TREND_CRTD_DT,
       TREND_SMPL_DT,
       TREND_ACKNOW_BY_USR_ID,
       TREND_GRAM_POS_NEG_CD
  FROM PEM_TREND
 ORDER BY PEM_TREND_ID DESC
EOD;

$result = mysql_query($trend_query, $con);
